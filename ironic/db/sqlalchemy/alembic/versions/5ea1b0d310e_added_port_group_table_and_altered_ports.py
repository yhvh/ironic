...
def downgrade():
    op.drop_constraint('fk_portgroups_ports', 'ports', type_='foreignkey')
    op.drop_column(u'ports', 'pxe_enabled')
    op.drop_column(u'ports', 'portgroup_id')
    op.drop_column(u'ports', 'local_link_connection')
    op.drop_table('portgroups')
